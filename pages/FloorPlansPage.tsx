...
const FloorPlanDetailView: React.FC<{ plan: FloorPlan; onBack: () => void }> = ({ plan, onBack }) => {
    return (
        <div className="min-h-screen">
            <header className="sticky top-0 z-20 bg-white/80 dark:bg-charcoal/80 backdrop-blur-sm p-4 flex items-center gap-4">
                <button onClick={onBack} className="text-zinc-900 dark:text-white p-2 bg-gray-200 dark:bg-zinc-700 rounded-full hover:bg-gray-300 dark:hover:bg-zinc-600">
                    <ArrowLeftIcon className="h-5 w-5" />
                </button>
                <h2 className="text-lg font-bold text-zinc-900 dark:text-white truncate">{plan.sizeSqFt} sq.ft {plan.type} Plan</h2>
            </header>
            ...
            <div className="p-4 mt-4 text-xs text-center text-gray-500 bg-gray-50 dark:bg-zinc-900">
                        ...
                        <div className="p-4 md:w-2/3 flex flex-col">
                            ...
                            <div className="mt-auto pt-4 flex flex-col gap-2">
                                ...
                                <div className="flex gap-2">
                                    <ReactRouterDOM.Link to="/schedule-visit" className="flex-1 text-center bg-gray-200 dark:bg-zinc-700 hover:bg-gray-300 dark:hover:bg-zinc-600 text-zinc-900 dark:text-white font-semibold py-2 px-4 rounded-lg text-sm transition-colors">
                                        Book Site Visit
                                    </ReactRouterDOM.Link>
                                    <a 
                                        ...
                                        className="flex-1 text-center bg-gray-200 dark:bg-zinc-700 hover:bg-gray-300 dark:hover:bg-zinc-600 text-zinc-900 dark:text-white font-semibold py-2 px-4 rounded-lg text-sm transition-colors"
                                    >
                                        Enquire Now
                                    </a>
                                </div>
