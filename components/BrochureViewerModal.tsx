    ...
    return (
        ...
        >
            <motion.div
                ...
                className="bg-charcoal w-full h-full sm:max-w-4xl sm:max-h-[90vh] sm:rounded-xl flex flex-col overflow-hidden"
                onClick={e => e.stopPropagation()}
            >
                {/* Header */}
                <header className="flex-shrink-0 flex items-center justify-between p-4 bg-zinc-800 border-b border-golden-yellow/20">
                    <h3 className="text-lg font-bold text-white">Company Brochure</h3>
