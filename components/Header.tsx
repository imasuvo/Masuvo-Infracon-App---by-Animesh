            ...
            <div className="max-w-lg mx-auto px-4 sm:px-6">
                <div className="flex items-center justify-between h-16">
                    ...
                    <Link to="/" className="flex items-center gap-3 group">
                        <img src="/assets/logo.png" alt="Masuvo Infracon Pvt. Ltd. Logo" className="h-10 w-auto group-hover:scale-110 transition-transform duration-300" />
                        <div>
                    ...
                    <Link to="/saved" className="relative p-2 text-gray-300 hover:text-white transition-colors">
