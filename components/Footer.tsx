            ...
            <div className="max-w-lg mx-auto py-8 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <div className="mt-8 border-t border-gray-200 dark:border-zinc-800 pt-8 flex flex-col-reverse items-center gap-4 sm:flex-row sm:justify-between">
                     ...
                     <div className="flex space-x-6">
                        ...
                        <SocialIcon href={SOCIAL_LINKS.youtube}><svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/></svg></SocialIcon>
                     </div>
                </div>
            </div>
        </footer>
